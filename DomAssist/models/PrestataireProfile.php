...
class PrestataireProfile {
    ...
    public function find(int $id): array|false {
        $s = $this->db->prepare("
            SELECT pp.*, u.nom, u.prenom, u.email, u.telephone, u.photo_url, u.ville
    ...
    public function allValides(): array {
        return $this->db->query("
            SELECT pp.*, u.nom, u.prenom, u.email, u.photo_url, u.ville
            FROM prestataire_profile pp
            JOIN \"user\" u ON u.id_user = pp.id_user
    ...
    public function findEnAttente(): array {
        return $this->db->query("
            SELECT pp.*, u.nom, u.prenom, u.email, u.photo_url
            FROM prestataire_profile pp
            JOIN \"user\" u ON u.id_user = pp.id_user
    ...
    public function updateDossier(int $id_profile, array $d): bool {
        ...
        return $s->execute([
            ...
            isset($d['zone_intervention']) ? (is_string($d['zone_intervention']) ? $d['zone_intervention'] : json_encode($d['zone_intervention'])) : null,
