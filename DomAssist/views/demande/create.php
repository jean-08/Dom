    ...
    <div class="da-card p-4 shadow-sm rounded-3">
      <form method="POST" action="index.php?action=demande_create" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="adresse" class="form-control" placeholder="Numéro, rue, bâtiment..."
        ...
        <div class="mb-4">
          ...
          <input type="tel" name="telephone_contact" class="form-control" placeholder="06 XX XX XX XX"
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            <label class="form-label fw-semibold">Budget min. (€) <span class="text-muted small">(optionnel)</span></label>
            <input type="number" name="budget_min" class="form-control" min="0" step="0.01" placeholder="Ex : 50"
                   value="<?= htmlspecialchars($_POST['budget_min'] ?? '') ?>">
          </div>
          <div class="col-md-6">
            <label class="form-label fw-semibold">Budget max. (€) <span class="text-muted small">(optionnel)</span></label>
            <input type="number" name="budget_max" class="form-control" min="0" step="0.01" placeholder="Ex : 200"
