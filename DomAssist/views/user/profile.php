    ...
    <div class="da-card p-4">
      ...
      <div class="d-flex align-items-center gap-4 pb-4 mb-4 border-bottom flex-wrap">
        <div class="position-relative">
          <img src="<?= htmlspecialchars($avatarUrl) ?>" alt="Avatar" class="rounded-circle shadow-sm border border-3 border-white" style="width: 100px; height: 100px; object-fit: cover;">
          ...
          <form method="POST" action="index.php?action=profile" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                ...
                <input type="email" name="email_secondaire" class="form-control" placeholder="secours@example.com" value="<?= htmlspecialchars($u['email_secondaire'] ?? '') ?>">
              </div>
            </div>
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <input type="tel" name="telephone" class="form-control" placeholder="06 XX XX XX XX" value="<?= htmlspecialchars($u['telephone'] ?? '') ?>">
              </div>
              <div class="col-md-6">
                <label class="form-label fw-semibold">Ville de résidence</label>
                <input type="text" name="ville" class="form-control" placeholder="Paris, Lyon, Marseille..." value="<?= htmlspecialchars($u['ville'] ?? '') ?>">
              </div>
            </div>
            ...
            <div class="mb-3">
              <label class="form-label fw-semibold">Bio / Présentation personnelle</label>
              <textarea name="bio" class="form-control" rows="3" placeholder="Quelques mots sur vous..."><?= htmlspecialchars($u['bio'] ?? '') ?></textarea>
            </div>

            <div class="mb-4">
              <label class="form-label fw-semibold">Photo de profil / Avatar (JPG, PNG, WEBP)</label>
              <input type="file" name="photo_file" class="form-control" accept="image/jpeg,image/png,image/webp">
              <div class="form-text">Si aucune photo n'est choisie, un avatar SVG personnalisé est généré automatiquement.</div>
            </div>
