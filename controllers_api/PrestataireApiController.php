...
class PrestataireApiController
{
    ...
    public function candidater(): void
    {
        ...
        $this->prest->candidater([
            ...
            // Corrige BUG-011 : zone_intervention peut être un texte libre OU un objet JSON
            // (ex: {"villes":[...],"rayon_km":30}) selon le client API. trim() plantait sur
            // un tableau. La normalisation réelle (texte → JSON valide) est faite dans
            // models/Prestataire.php::candidater().
            'zone_intervention'   => $d['zone_intervention'] ?? null,
