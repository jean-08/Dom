...
class Service
{
    ...
    public function all(): array
    {
        return $this->db->query("
            SELECT id_category, id_category AS id_service, libelle, libelle AS nom, NULL AS description, ordre
    ...
    {
        $s = $this->db->prepare("
            SELECT id_category, id_category AS id_service, libelle, libelle AS nom, NULL AS description, ordre, actif
    ...
    {
        $s = $this->db->prepare("
            SELECT sc.id_category, sc.id_category AS id_service, sc.libelle, sc.libelle AS nom,
     ...
     */
    public function addCompetence(int $id_prestataire, int $id_service, ?string $niveau = null): bool
    {
        $s = $this->db->prepare("
