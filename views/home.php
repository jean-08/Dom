...
<div class="container py-4 home-shell">

  <div class="hero-card mb-5 animate-fade-in">
    <div class="row align-items-center g-4">
      <div class="col-lg-7">
        <span class="hero-badge mb-3">
          <i class="bi bi-shield-check"></i> Plateforme de mise en relation de confiance
        </span>
        <h1 class="display-4 fw-bold mb-3">Vos travaux & dépannages en toute sérénité</h1>
        <p class="lead mb-4">
          Publiez gratuitement votre besoin, comparez des prestataires qualifiés et gérez votre intervention avec clarté et confiance.
        </p>
        <div class="d-flex flex-wrap gap-3 justify-content-center justify-content-lg-start">
          <?php if ($userSess): ?>
            <a href="index.php?action=demande_create" class="btn btn-brand-home btn-lg px-4 shadow">
              <i class="bi bi-plus-circle me-2"></i>Publier une demande
            </a>
          <?php else: ?>
            <a href="index.php?action=register" class="btn btn-brand-home btn-lg px-4 shadow">
              <i class="bi bi-arrow-right-circle me-2"></i>Commencer gratuitement
            </a>
            <a href="index.php?action=login" class="btn btn-outline-home btn-lg px-4">
              Se connecter
            </a>
          <?php endif; ?>
        </div>
      ...
      <div class="col-lg-5 text-center">
        <div class="hero-side">
          ...
          <h5 class="fw-bold">Vous êtes un professionnel ?</h5>
          <p class="small mb-3">Développez votre clientèle locale, recevez des missions ciblées selon vos compétences et gérez vos interventions facilement.</p>
          <a href="index.php?action=prestataire_candidater" class="btn btn-warning-home btn-sm px-3 shadow-sm">
  ...
  <div class="row g-3 mb-5">
    <div class="col-md-4">
      <div class="home-stat">
        <div class="d-flex align-items-center gap-3">
          <div class="icon-pill bg-primary"><i class="bi bi-check2-square"></i></div>
          <div>
    ...
    <div class="col-md-4">
      <div class="home-stat">
        <div class="d-flex align-items-center gap-3">
          <div class="icon-pill bg-success"><i class="bi bi-shield-lock"></i></div>
          <div>
    ...
    <div class="col-md-4">
      <div class="home-stat">
        <div class="d-flex align-items-center gap-3">
          <div class="icon-pill bg-warning"><i class="bi bi-chat-heart"></i></div>
          <div>
  ...
  <section id="garanties" class="mb-5">
    <div class="text-center mb-4">
      <h2 class="section-title fw-bold">Pourquoi choisir DomAssist ?</h2>
      <p class="section-subtitle">Une expérience repensée pour garantir la satisfaction du client et l'excellence des intervenants.</p>
    </div>

    <div class="row g-4">
      <div class="col-md-6 col-lg-3">
        <div class="home-card p-4 h-100 text-center">
          <div class="icon-pill bg-primary mx-auto mb-3">
            <i class="bi bi-geo-alt-fill"></i>
          </div>
          <h6 class="fw-bold mb-2">Matching Géolocalisé</h6>
          <p class="small mb-0">Vos demandes sont transmises aux prestataires qualifiés intervenant précisément dans votre ville ou rayon d'action.</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-3">
        <div class="home-card p-4 h-100 text-center">
          <div class="icon-pill bg-success mx-auto mb-3">
            <i class="bi bi-diagram-3-fill"></i>
          </div>
          <h6 class="fw-bold mb-2">Propositions en Concurrence</h6>
          <p class="small mb-0">Pas d'attribution automatique. Vous recevez plusieurs offres (prix, délais, message) et choisissez librement votre prestataire.</p>
        </div>
      </div>
      <!-- <div class="col-md-6 col-lg-3">
        <div class="da-card da-card-interactive p-4 h-100 text-center">
          ...
          <p class="small text-dark mb-0">Posez des questions, précisez vos créneaux et échangez des photos en toute confidentialité sur le fil de discussion de la demande.</p>
        </div>
      </div> -->
      <div class="col-md-6 col-lg-3">
        <div class="home-card p-4 h-100 text-center">
          <div class="icon-pill bg-warning mx-auto mb-3">
            <i class="bi bi-star-fill"></i>
          </div>
          <h6 class="fw-bold mb-2">Réputation & Avis Réels</h6>
          <p class="small mb-0">Les avis sont uniquement déposés suite à une intervention clôturée pour une totale authenticité des notes.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="categories" class="mb-5">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
      <div>
        <h2 class="section-title fw-bold mb-1">Domaines d'intervention</h2>
        <p class="section-subtitle mb-0">Découvrez l'ensemble de nos catégories de services spécialisés.</p>
      </div>
    </div>
        ...
        <?php foreach ($categories as $cat): ?>
          ...
          <div class="col-6 col-md-4 col-lg-3">
            <div class="category-item">
              <div class="icon-pill bg-primary">
                <i class="bi <?= getCategoryIconClass($lib) ?>"></i>
              </div>
              <div>
                <div class="fw-semibold"><?= htmlspecialchars($lib) ?></div>
                <div class="small">Service vérifié</div>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
  ...
  <section id="comment-ca-marche" class="mb-5">
    <div class="home-card p-5 bg-white">
      <div class="text-center mb-5">
        <h2 class="section-title fw-bold">Comment ça marche ?</h2>
        <p class="section-subtitle">3 étapes simples pour réussir tous vos travaux d'aménagement et de dépannage.</p>
      </div>
      ...
      <div class="row g-4">
        <div class="col-md-4 text-center">
          <div class="step-box">
            ...
            <h5 class="fw-bold">Décrivez votre besoin</h5>
            <p class="small mb-0">Publiez votre demande avec titre, adresse, niveau d'urgence, créneaux préférés et photos d'illustration du problème.</p>
          </div>
        </div>
        <div class="col-md-4 text-center">
          <div class="step-box">
            <div class="step-number">2</div>
            <h5 class="fw-bold">Comparez & Choisissez</h5>
            <p class="small mb-0">Recevez les propositions des prestataires qualifiés. Retenez un prestataire idéal.</p>
          </div>
        </div>
        <div class="col-md-4 text-center">
          <div class="step-box">
            <div class="step-number">3</div>
            <h5 class="fw-bold">Intervention & Clôture</h5>
            <p class="small mb-0">Le prestataire établit le diagnostic, exécute la prestation et vous validez la fin de l'intervention avant de déposer votre avis.</p>
          </div>
        </div>
      </div>
    </div>
