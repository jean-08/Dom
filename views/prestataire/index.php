        ...
        <div class="da-card p-3 h-100 d-flex flex-column">
          <div class="d-flex align-items-center gap-2 mb-2">
            <?php if (!empty($p['photo_url'])): ?>
              <img src="<?= htmlspecialchars(UploadHelper::getAvatarUrl($p['photo_url'] ?? null, $p['prenom'] ?? 'User', $p['nom'] ?? '')) ?>" alt="Avatar" class="avatar-circle" style="width: 42px; height: 42px; object-fit: cover;">
            <?php else: ?>
